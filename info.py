...
DATABASE_NAME = environ.get('DATABASE_NAME', "angel-luciferbot")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'tgnvs')
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🎬Title:</b> <b><a href={url}>{title}</a></b>\n⏱<b>Duration:</b> {runtime}min | ⭐ <b>{rating} / 10</b> | <a href="{url}"><b>IMDb</b></a>\n\n🔊<b>Languages:</b> #{languages}\n🌐<b>Country of Origin:</b> #{countries}\n🗓<b>Release Info:</b> {release_date}\n\n🎦<b>Director:</b> {director}\n<b>Writers:</b> {writer}\n<b>Stars:</b> {cast}\n\n⚙<b>Genres: {genres}</b>\n\n📺 𝗝𝗢𝗜𝗡 : <b>@MOVIES_EMPERIO</b>")
...
SHORTENER_API = environ.get("SHORTENER_API", "b489a45fc99e72c4e7c454ed14a3e78b6ddba040")
